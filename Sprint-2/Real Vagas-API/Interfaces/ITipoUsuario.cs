...
namespace Real_Vagas_API.Interfaces
{
    interface ITipoUsuario
    {
        ...
        void Cadastrar(DbTipoUsuarioDomain tipousuario); //Para cadastrar um novo tipo de usuario
        void AtualizarTipoUsuarioId(int id, DbTipoUsuarioDomain tipousuario); //Atualizar tipo usuario passando seu id na url
